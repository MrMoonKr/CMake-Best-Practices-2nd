...
static inline bool col_mov_test_top( const RECT* stat, const RECT* rect, const MOVE* vel )
{
    return col_mov_test_dir( stat->top, rect->bottom, vel->y );
}

static inline bool col_mov_test_left( const RECT* stat, const RECT* rect, const MOVE* vel )
{
    return col_mov_test_dir( stat->left, rect->right, vel->x );
}

static inline bool col_mov_test_bottom( const RECT* stat, const RECT* rect, const MOVE* vel )
{
    return col_mov_test_dir( -stat->bottom, -rect->top, -vel->y );
}

static inline bool col_mov_test_right( const RECT* stat, const RECT* rect, const MOVE* vel )
{
    return col_mov_test_dir( -stat->right, -rect->left, -vel->x );
}
...
static inline bool col_move_test_y(const RECT *stat, const RECT *rect, const MOVE *vel)
{
    return col_mov_test_axis(stat->top, stat->bottom, rect->top, rect->bottom, vel->y);
}

static inline bool col_move_test_x(const RECT *stat, const RECT *rect, const MOVE *vel)
{
